...
const jumpToLink = (link: string) => windowOpen(link);
</script>
    ...
    <div v-for="(msg, index) in actualMessages" :key="msg.id" class="message-list-item">
      <div class="list-item-left">
        ...
        <div>
          ...
          <OLink @click="jumpToLink(msg.source_url)" class="link" color="primary" :style="{ fontWeight: msg.is_read ? 'normal' : 'bold' }">{{ msg.summary }}</OLink>
        </div>
      </div>
